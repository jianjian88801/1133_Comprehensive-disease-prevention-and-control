...
public class JiezhongjiluView extends JiezhongjiluEntity implements Serializable {
	...
	public JiezhongjiluView(JiezhongjiluEntity jiezhongjiluEntity) {
		try {
			...
			* 获取： 接种类型的值
			*/
			public String getJiezhongValue() {
				return jiezhongValue;
			}
			/**
			* 设置： 接种类型的值
			*/
			public void setJiezhongValue(String jiezhongValue) {
				this.jiezhongValue = jiezhongValue;
			}
