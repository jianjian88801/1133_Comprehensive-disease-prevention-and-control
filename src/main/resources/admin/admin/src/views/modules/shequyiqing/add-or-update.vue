    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="标题" prop="shequyiqingName">
                       <el-input v-model="ruleForm.shequyiqingName"
                                 placeholder="标题" clearable  :readonly="ro.shequyiqingName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="标题" prop="shequyiqingName">
                           <el-input v-model="ruleForm.shequyiqingName"
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.gonggaoPhoto" label="照片" prop="gonggaoPhoto">
                        <file-upload
                            tip="点击上传照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.gonggaoPhoto" label="照片" prop="gonggaoPhoto">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="内容" prop="shequyiqingContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.shequyiqingContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shequyiqingContent" label="内容" prop="shequyiqingContent">
                            <span v-html="ruleForm.shequyiqingContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    shequyiqingName: false,
                    gonggaoPhoto: false,
                    shequyiqingContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shequyiqing/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shequyiqingCrossAddOrUpdateFlag = false;
                                        this.parent.search();
