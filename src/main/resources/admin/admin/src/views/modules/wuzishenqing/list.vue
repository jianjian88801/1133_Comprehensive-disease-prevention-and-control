        ...
        <el-dialog title="审核" :visible.sync="wuzishenqingYesnoTypesVisible">
            <el-form :model="form">
                ...
                <el-form-item label="审核" >
                    <el-select v-model="form.wuzishenqingYesnoTypes" placeholder="请选择审核类型">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="wuzishenqingYesnoTypesShenhe">提 交</el-button>
            </div>
        </el-dialog>
        <!-- 条件查询 -->
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '派发地点' : ''">
                        <el-select v-model="searchForm.wuzishenqingPaifaTypes" placeholder="请选择派发地点">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in wuzishenqingPaifaTypesSelectSearch"
                               v-bind:key="index"
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/jibingfangkong/upload/wuzishenqingMuBan.xls"
                        >批量导入物资申请数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('wuzishenqing','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="wuziPhoto"
                        ...
                        <template slot-scope="scope">
                            <div v-if="scope.row.wuziPhoto">
                                <img :src="scope.row.wuziPhoto" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="wuzishenqingNumber"
                                      header-align="center"
                                      label="申请数量">
                        <template slot-scope="scope">
                            {{scope.row.wuzishenqingNumber}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="wuzishenqingPaifaTypes"
                                      header-align="center"
                                      label="派发地点">
                        <template slot-scope="scope">
                            {{scope.row.wuzishenqingPaifaValue}}
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('wuzishenqing','审核') && scope.row.wuzishenqingYesnoTypes == 1 " type="primary" icon="el-icon-thumb" size="mini" @click="openYesnoTypes(scope.row.id,scope.row.wuziId,scope.row.wuzishenqingNumber)">审核</el-button>
...
<script>
    ...
    //当前表下拉框搜索条件
              wuzishenqingPaifaTypesSelectSearch : [],
              wuzishenqingYesnoTypesSelectSearch : [],
            form:{
                id : null,
                wuziId : null,
                yonghuId : null,
                wuzishenqingNumber : null,
                wuzishenqingContent : null,
                wuzishenqingPaifaTypes : null,
                insertTime : null,
            ...
            json_fields: {
                //级联表字段
                     ...
                     '电子邮箱': 'yonghuEmail',
                //本表字段
                     '申请数量': "wuzishenqingNumber",
                     '派发地点': "wuzishenqingPaifaTypes",
                     '申请时间': "insertTime",
                     '审核状态': "wuzishenqingYesnoTypes",
                     '回复意见': "wuzishenqingYesnoText",
                     '审核时间': "updateTime",
            },
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :"wuzishenqing",//当前表表名,
                        sumColum : 'wuzishenqing_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'wuzishenqing_name',//分组字符串字段
                        // types : 'wuzishenqing_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
                ...
                //         groupColumn: "wuzishenqing_types",
                //     }
                //     this.$http({
            ...
            getDataList() {
                ...
                if (this.searchForm.wuzishenqingPaifaTypes!= '' && this.searchForm.wuzishenqingPaifaTypes!= undefined) {
                    params['wuzishenqingPaifaTypes'] = this.searchForm.wuzishenqingPaifaTypes
                }
                ...
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=wuzishenqing_paifa_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.wuzishenqingPaifaTypesSelectSearch = data.data.list;
                    }
                });
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=wuzishenqing_yesno_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
            ...
            openYesnoTypes(id,wuziId,wuzishenqingNumber) {
                let _this = this;
                _this.form.id = id;
                _this.form.wuziId = wuziId;
                _this.form.wuzishenqingNumber = wuzishenqingNumber;
                _this.form.wuzishenqingYesnoTypes = "请选择审核结果";
                _this.wuzishenqingYesnoTypesVisible = true;
            },

            wuzishenqingYesnoTypesShenhe() {
                let _this = this;
                if(_this.form.wuzishenqingYesnoTypes == "请选择审核结果"){
                    alert("请选择审核结果");
                    return false;
                }
                this.$http({
                    url:`wuzishenqing/shenqing`,
                    method: "post",
                    data: _this.form
                }).then(({ data }) => {
                    if (data && data.code === 0) {
