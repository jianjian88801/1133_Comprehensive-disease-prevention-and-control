    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="接种编号" prop="jiezhongjiluUuidNumber">
                       <el-input v-model="ruleForm.jiezhongjiluUuidNumber"
                                 placeholder="接种编号" clearable  :readonly="ro.jiezhongjiluUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="接种编号" prop="jiezhongjiluUuidNumber">
                           <el-input v-model="ruleForm.jiezhongjiluUuidNumber"
                                     placeholder="接种编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="接种时间" prop="jiezhongTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.jiezhongTime"
                                type="datetime"
                                placeholder="接种时间"
                                :disabled="ro.jiezhongTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiezhongTime" label="接种时间" prop="jiezhongTime">
                            <span v-html="ruleForm.jiezhongTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="接种类型" prop="jiezhongTypes">
                        <el-select v-model="ruleForm.jiezhongTypes" :disabled="ro.jiezhongTypes" placeholder="请选择接种类型">
                            <el-option
                                v-for="(item,index) in jiezhongTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="接种类型" prop="jiezhongValue">
                        <el-input v-model="ruleForm.jiezhongValue"
                            placeholder="接种类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="jiezhongjiluContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.jiezhongjiluContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiezhongjiluContent" label="备注" prop="jiezhongjiluContent">
                            <span v-html="ruleForm.jiezhongjiluContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    jiezhongjiluUuidNumber: false,
                    jiezhongTime: false,
                    jiezhongTypes: false,
                    jiezhongjiluContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                    jiezhongjiluUuidNumber: new Date().getTime(),
                    jiezhongTime: '',
                    jiezhongTypes: '',
                    jiezhongjiluContent: '',
                    insertTime: '',
                },
                jiezhongTypesOptions : [],
                yonghuOptions : [],
                rules: {
                   yonghuId: [
                   ...
                   jiezhongjiluUuidNumber: [
                              { required: true, message: '接种编号不能为空', trigger: 'blur' },
                          ],
                   jiezhongTime: [
                              { required: true, message: '接种时间不能为空', trigger: 'blur' },
                          ],
                   jiezhongTypes: [
                              { required: true, message: '接种类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jiezhong_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jiezhongTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jiezhongjilu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jiezhongjiluCrossAddOrUpdateFlag = false;
                                        this.parent.search();
