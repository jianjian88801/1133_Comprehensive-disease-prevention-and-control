    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="申请数量" prop="wuzishenqingNumber">
                       <el-input v-model="ruleForm.wuzishenqingNumber"
                                 placeholder="申请数量" clearable  :readonly="ro.wuzishenqingNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="申请数量" prop="wuzishenqingNumber">
                           <el-input v-model="ruleForm.wuzishenqingNumber"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="申请理由" prop="wuzishenqingContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.wuzishenqingContent" label="申请理由" prop="wuzishenqingContent">
                            <span v-html="ruleForm.wuzishenqingContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="派发地点" prop="wuzishenqingPaifaTypes">
                        <el-select v-model="ruleForm.wuzishenqingPaifaTypes" :disabled="ro.wuzishenqingPaifaTypes" placeholder="请选择派发地点">
                            <el-option
                                v-for="(item,index) in wuzishenqingPaifaTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="派发地点" prop="wuzishenqingPaifaValue">
                        <el-input v-model="ruleForm.wuzishenqingPaifaValue"
                            placeholder="派发地点" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    wuziId: false,
                    yonghuId: false,
                    wuzishenqingNumber: false,
                    wuzishenqingContent: false,
                    wuzishenqingPaifaTypes: false,
                    insertTime: false,
                ...
                ruleForm: {
                    ...
                    wuzishenqingNumber: '',
                    wuzishenqingContent: '',
                    wuzishenqingPaifaTypes: '',
                    insertTime: '',
                    wuzishenqingYesnoTypes: '',
                    wuzishenqingYesnoText: '',
                    updateTime: '',
                },
                wuzishenqingPaifaTypesOptions : [],
                ...
                rules: {
                   ...
                   wuzishenqingPaifaTypes: [
                              { required: true, message: '派发地点不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   wuzishenqingYesnoText: [
                              { required: true, message: '回复意见不能为空', trigger: 'blur' },
                          ],
                   updateTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=wuzishenqing_paifa_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.wuzishenqingPaifaTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=wuzishenqing_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
