    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.dakaPhoto" label="打卡照片" prop="dakaPhoto">
                        <file-upload
                            tip="点击上传打卡照片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.dakaPhoto?ruleForm.dakaPhoto:''"
                            @change="dakaPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.dakaPhoto" label="打卡照片" prop="dakaPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.dakaPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   dakaPhoto: [
                              { required: true, message: '打卡照片不能为空', trigger: 'blur' },
                          ],
                   dakaContent: [
        ...
        methods: {
            ...
            //图片
            dakaPhotoUploadChange(fileUrls){
                this.ruleForm.dakaPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
