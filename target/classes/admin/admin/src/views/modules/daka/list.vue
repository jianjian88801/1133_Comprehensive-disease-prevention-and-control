        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/jibingfangkong/upload/dakaMuBan.xls"
                        >批量导入打卡数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('daka','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="dakaPhoto"
                                     header-align="center"
                                     width="200"
                                     label="打卡照片">
                        <template slot-scope="scope">
                            <div v-if="scope.row.dakaPhoto">
                                <img :src="scope.row.dakaPhoto" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>
