                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/jibingfangkong/upload/wuziMuBan.xls"
                        >批量导入物资数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('wuzi','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('wuzi','修改')" type="primary" icon="el-icon-add-location" size="mini" @click="plusWuziKucunNumber(scope.row.id,scope.row.wuziKucunNumber)">增加库存</el-button>
                            <el-button v-if="isAuth('wuzi','修改')" type="primary" icon="el-icon-delete-location" size="mini" @click="reduceWuziKucunNumber(scope.row.id,scope.row.wuziKucunNumber)">减少库存</el-button>
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
			...
			//数据不为空放值
				...
				//标题
				this.wuziKucunNumberTitle = '增加库存'
			},
			//减少库存
			...
			//数据不为空放值
				...
				this.wuziKucunNumberVisible = true;
				//标题
				this.wuziKucunNumberTitle = '减少库存'
			},
			//提交用户操作库存数量
			addWuziKucunNumber(){
				var type = null
